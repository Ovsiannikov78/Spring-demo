...
public class CreateInstructorDemo {
    public static void main(String[] args) {
        ...
        try {
            ...
            Instructor tempInstructor = new Instructor("Alex", "Schreiner", "alex@googlemail.com");

            InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.youtube.com", "chess");
